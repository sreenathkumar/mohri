...
export default function TaskCard({
    ...
    return (
        <div className={`group bg-gradient-to-br border rounded-xl p-5 space-y-4 transition-all duration-300 ${isOutForDelivery
            ? 'from-secondary/20 to-secondary/10 border-secondary/50 hover:border-secondary/70 hover:shadow-lg hover:shadow-secondary/20'
            ...
            {isOutForDelivery && (
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 bg-secondary/30 px-3 py-1 rounded-full">
                        ...
                        <span className="text-xs font-semibold text-secondary">Out for Delivery</span>
                    </div>
                </div>
            )}
            ...
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className={`text-sm font-semibold font-mono ${isOutForDelivery ? 'text-secondary' : 'text-primary'}`}>{id}</p>
                </div>
                <div className="flex items-center gap-1.5">
                    ...
                    <button
                        ...
                        className="w-10 h-10 rounded-lg bg-destructive/10 hover:bg-primary/90 text-white flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95"
                    >
                        <TriangleAlert className="text-destructive text-lg" />
                    </button>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-3 bg-secondary/10 rounded-lg p-3 border border-secondary/20">
                <div>
            ...
            {showMore && (
                <div className="border-t border-border/30 pt-3 space-y-2 text-xs animate-in fade-in-50 duration-200">
                    ...
                    <div className="bg-muted/40 rounded p-2">
                        ...
                        <p className="font-semibold text-foreground">Ring bell twice</p>
                    </div>
                </div>
            )}
